    ...
    <script>
        $(function () {
            $("button.addToCart").click(function (){
                ...
                //location.href = "http://localhost:8088/book/cartServlet?action=addItem&id="+bookId;
                //使用ajax请求
               $.getJSON("http://localhost:8088/book/cartServlet","action=ajaxAddItem&id="+bookId,function (data) {
